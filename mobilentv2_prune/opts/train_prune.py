...
# ========================= File Paths =============================
    ...
    parser.add_argument('--result_path', default='/home/root5/GeScale/ms/my_mobilenetv2/results/SHGD13_prune', type=str, help='Result directory path')
    parser.add_argument('--resume_path', default='', type=str, help='Save data (.pth) of previous training')
    parser.add_argument('--pretrain_path', default='/home/root5/GeScale/ms/my_mobilenetv2/results/SHGD13_sparsity/SHGD_mobilenetv2_IRD_8_best.pth', type=str, help='Pretrained model (.pth)')
...
# ========================= Training Configs ==========================
    ...
    parser.add_argument('--learning_rate', default=0.05, type=float, help='Initial learning rate (divided by 10 while training by lr scheduler)')

...
# ========================= File Paths =============================
    ...
    parser.add_argument('--result_path', default='/home/root5/GeScale/choyaa-GeScale-master/my__netslimming+3D/results/SHGD13_sparsity', type=str, help='Result directory path')
    parser.add_argument('--resume_path', default='', type=str, help='Save data (.pth) of previous training')
    parser.add_argument('--pretrain_path', default='/home/root5/GeScale/choyaa-GeScale-master/my__netslimming+3D/results/SHGD15_1/SHGD_mobilenetv2_IRD_8_best.pth', type=str, help='Pretrained model (.pth)')
...
# ========================= Model Configs ==========================
    ...
    parser.add_argument('--store_name', default='SHGD13_mobilenetv2_IRD_8_sparsity_checkpoint', type=str, help='Name to store checkpoints')
...
#=========================sparsity ============================================
    ...
    parser.set_defaults(sparsity_regularization=True)

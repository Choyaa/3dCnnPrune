...
# ========================= File Paths =============================
    ...
    parser.add_argument('--video_path', default='/home/root5/GeScale/SHGD/SHGD_Tuples/set1', type=str, help='Directory path of Videos')
    parser.add_argument('--annotation_path', default='/home/root5/GeScale/SHGD/SHGD_Tuples', type=str, help='Annotation file path')
    ...
    parser.add_argument('--result_path', default='/home/root5/GeScale/ms/my_mobilenetv2/results/test', type=str, help='Result directory path')
    parser.add_argument('--resume_path', default='/home/root5/GeScale/ms/my_mobilenetv2/results/SHGD13_prune/SHGD_mobilenetv2_IRD_8_best.pth', type=str, help='Save data (.pth) of previous training')

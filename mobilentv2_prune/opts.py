...
# ========================= File Paths =============================
    ...
    parser.add_argument('--video_path', default='/home/choya/gescale/set1', type=str, help='Directory path of Videos')
    parser.add_argument('--annotation_path', default='/home/choya/gescale/set1', type=str, help='Annotation file path')
    parser.add_argument('--train_list', default='SHGD13_trainlist.txt', type=str, help='File name of train list')
    parser.add_argument('--val_list', default='SHGD13_vallist.txt', type=str, help='File name of validation list')
    parser.add_argument('--test_list', default='tuples.txt', type=str, help='File name of test list')
    parser.add_argument('--result_path', default='/home/choya/gescale/ms/my_mobilenetv2/results/test', type=str, help='Result directory path')
    parser.add_argument('--resume_path', default='/home/choya/gescale/ms/my_mobilenetv2/results/SHGD13_prune/SHGD_mobilenetv2_IRD_8_best.pth', type=str, help='Save data (.pth) of previous training')
    parser.add_argument('--pretrain_path', default='/home/choya/gescale/ms/my_mobilenetv2/results/test/SHGD_mobilenetv2_IRD_8_pruned40.pth', type=str, help='Pretrained model (.pth)')
...
# ========================= Model Configs ==========================
    ...
    parser.add_argument('--store_name', default='mobilenetv2_SHGD13_IRD', type=str, help='Name to store checkpoints')
...
# ========================= Training Configs ==========================
    ...
    parser.add_argument('--width_mult', default=1, type=float, help='The applied width multiplier to scale number of filters')
...
#========================= prune ===============================================
    parser.add_argument('--pruneratio', type=float, default=0.8,

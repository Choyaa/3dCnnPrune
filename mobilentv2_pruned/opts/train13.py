...
# ========================= File Paths =============================
    ...
    parser.add_argument('--video_path', default='/home/root5/GeScale/SHGD/SHGD/SHGDsingle', type=str, help='Directory path of Videos')
    parser.add_argument('--annotation_path', default='/home/root5/GeScale/GeScale_3D/SHGD', type=str, help='Annotation file path')
    ...
    parser.add_argument('--result_path', default='/home/root5/GeScale/GeScale_3D/results', type=str, help='Result directory path')
    parser.add_argument('--resume_path', default='/home/root5/GeScale/GeScale_3D/results/SHGD_mobilenetv2_IRD_8_checkpoint.pth', type=str, help='Save data (.pth) of previous training')
    parser.add_argument('--pretrain_path', default='/home/root5/GeScale/GeScale_3D/pretrained_models/SHGD15_mobilenetv2_IRD_8_best.pth', type=str, help='Pretrained model (.pth)')

...
# ========================= File Paths =============================
    ...
    parser.add_argument('--video_path', default=r'C:\Jester\archive', type=str, help='Directory path of Videos')
    parser.add_argument('--annotation_path', default=r'C:\Users\123\Desktop\GeScale_3D\Jester', type=str, help='Annotation file path')
    parser.add_argument('--train_list', default='train_videofolder.txt', type=str, help='File name of train list')
    parser.add_argument('--val_list', default='val_videofolder.txt', type=str, help='File name of validation list')
...
# ========================= Model Configs ==========================
    ...
    parser.add_argument('--store_name', default='squeezenet_jester_rgb', type=str, help='Name to store checkpoints')

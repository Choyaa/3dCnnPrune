...
# ========================= File Paths =============================
    ...
    parser.add_argument('--annotation_path', default=r'C:\SHGD\SHGD\SHGD_Single\annotation-SHGD13', type=str, help='Annotation file path')
    ...
    parser.add_argument('--result_path', default=r'C:\Users\123\Desktop\GeScale_3D\results\SHGD13', type=str, help='Result directory path')
    parser.add_argument('--resume_path', default=r'C:\Users\123\Desktop\GeScale_3D\results\SHGD13\SHGD_squeezenet_IRD_8_checkpoint.pth', type=str, help='Save data (.pth) of previous training')
    parser.add_argument('--pretrain_path', default=r'C:\Users\123\Desktop\GeScale_3D\results\SHGD15_1\SHGD_squeezenet_IRD_8_best.pth', type=str, help='Pretrained model (.pth)')
...
# ========================= Model Configs ==========================
    ...
    parser.add_argument('--store_name', default='squeezenet_shgd13_ird', type=str, help='Name to store checkpoints')
    ...
    parser.add_argument('--n_classes', default=15, type=int, help='Number of classes (jester: 27, SHGD: 15)')

...
# ========================= File Paths =============================
    ...
    parser.add_argument('--video_path', default=r'C:\SHGD\SHGD\SHGD_Single', type=str, help='Directory path of Videos')
    parser.add_argument('--annotation_path', default=r'C:\SHGD\SHGD\SHGD_Single\annotation-SHGD15', type=str, help='Annotation file path')
    parser.add_argument('--train_list', default='SHGD15_trainlist.txt', type=str, help='File name of train list')
    parser.add_argument('--val_list', default='SHGD15_vallist.txt', type=str, help='File name of validation list')
    parser.add_argument('--test_list', default='tuples.txt', type=str, help='File name of test list')
    parser.add_argument('--result_path', default=r'C:\Users\123\Desktop\GeScale_3D\results\SHGD15_1', type=str, help='Result directory path')
    parser.add_argument('--resume_path', default=r'C:\Users\123\Desktop\GeScale_3D\results\SHGD15_1\SHGD_squeezenet_IRD_8_checkpoint.pth', type=str, help='Save data (.pth) of previous training')
    parser.add_argument('--pretrain_path', default=r'C:\Users\123\Desktop\GeScale_3D\results\Jester\jester_squeezenet_RGB_8_best.pth', type=str, help='Pretrained model (.pth)')

# ========================= Model Configs ==========================
    parser.add_argument('--model', default='squeezenet', type=str, help='(squeezenet1_1 | mobilenetv2 ')
    ...
    parser.add_argument('--store_name', default='squeezenet_shgd15_ird', type=str, help='Name to store checkpoints')

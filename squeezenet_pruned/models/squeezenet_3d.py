...
class SqueezeNet(nn.Module):
    ...
    def __init__(self,
        ...
        if cfg is None:
            ...
            #cfg = [22, 11, 28, 27, 12, 3, 49, 29, 2, 27, 27, 3, 47, 43, 3, 11, 44, 3, 12, 46, 3, 13, 50, 125, 255]
        if version == 1.1:
            self.features = nn.Sequential(
                nn.Conv3d(3, cfg[0], kernel_size=3, stride=(1,2,2), padding=(1,1,1)),
...
if __name__ == '__main__':
    ...
    for k, v in model.state_dict().items():
        print(k)
    input_var = torch.randn(8, 3, 32, 112, 112).cuda()

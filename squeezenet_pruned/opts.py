...
# ========================= File Paths =============================
    ...
    parser.add_argument('--video_path', default=r'/home/choya/gescale/set1', type=str, help='Directory path of Videos')
    parser.add_argument('--annotation_path', default=r'/home/choya/gitee/squeezenet_pruned', type=str, help='Annotation file path')
    ...
    parser.add_argument('--result_path', default=r'/home/choya/gescale/GeScale_3D/results', type=str, help='Result directory path')
    parser.add_argument('--resume_path', default=r'/home/choya/gitee/squeezenet_pruned/results/SHGD_prune/SHGD_squeezenet_IRD_8_best.pth', type=str, help='Save data (.pth) of previous training')
    parser.add_argument('--pretrain_path', default=r'/home/choya/gitee/squeezenet_pruned/results/SHGD13/SHGD_squeezenet_IRD_8_best.pth', type=str, help='Pretrained model (.pth)')
